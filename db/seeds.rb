...
Post.create(title: 'Introduction to Psychology', description: 'Likey New', course_number: 'ENWR 1510', professor: 'Rich Zhu', price: 20, user_id: 1)

Post.create(title: '我今天有点膨胀', description: 'Used', course_number: 'PHIL 4510', professor: '陈奕恺', price: 150, user_id: 2)

Post.create(title: 'Topics in Javascript', description: 'Acceptable', course_number: 'COMP 2510', professor: 'Dounan', price: 35, user_id: 3)
